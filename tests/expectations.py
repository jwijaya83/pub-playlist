...
class PlaylistExpectations:
    def __init__(self, songs: list, songs_col_names: list, playlists: list, playlists_col_names: list,
        ...
        self.songs_in_playlists = pd.DataFrame(data=songs_in_playlists, columns=sip_names)
    ...
    def update_playlists_df(self):
        ...
        self.songs_in_playlists = pd.DataFrame(data=db_communicator.get_all_songs_in_playlists(),
